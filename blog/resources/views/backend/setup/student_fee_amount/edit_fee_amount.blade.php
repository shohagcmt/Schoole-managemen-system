            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" action="{{ route('setups.student.fee.amount.update',$editData[0]->student_fee_category_id) }}"
                                        ...
                                        <div class="form-group col-md-5">
                                            ...
                                            <select name="student_fee_category_id" class="form-control" id="">
                                                ...
                                                @foreach ($categorys as $category)
                                                    <option value="{{ $category->id }}" {{ ($editData['0']->student_fee_category_id==$category->id)? "selected":"" }}>{{ $category->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    @foreach ($editData as $edit)     
                                    <div class="delete_whole_extra_item_add" id="delete_whole_extra_item_add">   <!-- extra_add_item removeeventmore div -->
                                    <div class="form-row"> 
                                        <div class="form-group col-md-5">
                                        ...
                                        <div class="form-row">
                                                ...
                                                <span class="btn btn-danger removeeventmore"><i class="fa fa-minus-circle"></i></span>  <!-- extra_add_item removeeventmore Button -->       
                                            </div>
                                        </div>
                                    </div>
                                    </div>
