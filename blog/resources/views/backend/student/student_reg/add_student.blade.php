          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form method="POST" action="{{ (@$editData) ? route('student.registration.update',[$editData->id,$editData->student_id]):route('student.registration.store') }}" role="form" id="MyForm" enctype="multipart/form-data">
                  @csrf
                  <div class="card-body">
                    <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <select name="religion" id="" class="form-control form-control-sm" value="{{ old('religion') }}" placeholder="Enter Student Religion">
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <select name="student_fee_category_id" id="" class="form-control form-control-sm" value="{{ old('student_fee_category_id') }}" placeholder="Enter Student Category">
                    ...
                    <div class="form-group col-md-4">
                      <label>Shift</label> 
                      <select name="studentshift_id" id="" class="form-control form-control-sm" value="{{ old('studentshift_id') }}" placeholder="Enter Student Shift">
